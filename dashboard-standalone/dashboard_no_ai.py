...
# Removed parent directory from path to avoid importing AI components
from agentic_commerce_market_projection_extended import ExtendedAgenticCommerceProjection

# AI chatbot integration removed for standalone version
...
# AI chat integration removed for standalone version
